            ...
            <div className="flex flex-col md:flex-row gap-x-5">
                <div className="flex flex-col text-center md:text-left md:w-[30vw] mb-10">
                    ...
                    <motion.p
                        ...
                        animate="show"
                        exit="hidden"
                        className="max-w-md">Mi objetivo es construir soluciones web que destaquen y alcancen tus objetivos empresariales. ¡Trabajemos juntos para hacer realidad tu visión digital!
                    </motion.p>
                </div>
