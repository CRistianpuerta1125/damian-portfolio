            ...
            <div className="w-full h-full bg-gradient-to-r from-[#131424]/10 via-black/30 to-black/10">
                <div className="container grid items-center h-full px-5 mx-auto md:grid-cols-2 md:text-left">
                    <motion.div className="hidden w-auto h-auto mx-auto md:block"
                        ...
                        exit="hidden"
                    >
                        <Image src="/assets/home-44.png" priority width="500" height="500" alt="Avatar" />
                    </motion.div>
                    ...
                    <motion.div variants={fadeIn("left", 0.5)}
                        ...
                        exit="hidden"
                    >
                        <h1 className="mb-5 text-4xl leading-tight md:mb-10">tu imaginación sigue el código <br />
                            <span className="text-secondary">programa sin fronteras.</span></h1>
                        <p className="max-w-sm  mb-10 text-xl md:max-w-2xl md:mx-0 md:mb-16 md:text-xl">
                        ¡Hola! Soy Damian, un apasionado desarrollador web. Transformo ideas en experiencias digitales y construyo sitios web atractivos que cautivan a los usuarios. ¡Bienvenido a mi mundo digital!
                        </p>
